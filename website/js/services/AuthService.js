angular.module('photoGallery.authService', ['photoGallery.utils'])
    .service('authService', function($q, $_, $localstorage, $http) {
        ...
        this.callApi = function(path, method) {
            var deferred = $q.defer();
            var data = {
                UserPoolId: USER_POOL_ID,
                ClientId: USER_POOL_CLIENT_ID,
            ...
            try {
                if (cognitoUser != null) {
                    cognitoUser.getSession(function(err, session) {
                        ...
                        paramsCredentials.Logins[USER_POOL_ID_IDP] = session.getIdToken().getJwtToken();
