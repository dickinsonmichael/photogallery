angular.module("photoGallery.loggedIn", ["photoGallery.authService"])
    .controller("loggedInController", function($scope, $location, authService) {
        if (true) {
            authService.isAuthenticated().then(function(result) {
                ...
                console.log(msg);
                $scope.errormessage = "Failed to check if user is authenticated";
                return;
            });
        } else {
        ...
        authService.callApi("images", "GET").then(function(result) {
        ...
        initPhotoSwipeFromDOM('.album-cover');
